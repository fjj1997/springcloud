package com.cddx.common.log.aspect;
...
import com.cddx.common.log.enums.BusinessStatus;
import com.cddx.common.log.service.AsyncLogService;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            operLog.setStatus(BusinessStatus.SUCCESS.getStatus());
            // 请求的地址
            ...
            if (e != null) {
                operLog.setStatus(BusinessStatus.FAIL.getStatus());
