...
public enum ResponseEnum {
    ...
    FILE_SIZE_LIMIT_ERROR(418, "文件过大"),
    DEFAULT_FAILED_MSG(419, "短信服务繁忙，请稍后再请求"),
    OUT_DATE_VALIDATE_IMAGE(420, "校验图片已过期"),
    DEVICE_CODE_REPEAT(421, "检测到设备编码重复"),
    SYSTEM_DATA_ERROR(422, "禁止操作系统创建的数据"),
    BUSY_BUSINESS(423, "业务繁忙"),
    ...
    NOT_SET_DEFAULT_TEMPLATE(434,"企业还未设置默认名片模板！"),
